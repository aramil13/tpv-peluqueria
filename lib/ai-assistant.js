...
2. MULTISERVICIO: searchService de cada uno → guarda TODOS los IDs → checkAvailability({date, serviceIds:[ID1,ID2]}) → bookAppointment({serviceIds:[ID1,ID2], date, time, employeeId}). SIEMPRE con TODOS los IDs juntos.
