...
const SYNC_URL = env.VERCEL_SYNC_URL || env.SYNC_FORWARD_URL || 'https://tpv-peluqueria.vercel.app/sync';
const SYNC_KEY = env.VERCEL_SYNC_KEY || '';
...
async function fetchData() {
  ...
  const syncUrls = [SYNC_URL.replace(/\/+$/, ''), 'https://tpv-peluqueria.vercel.app/api', 'https://tpv-peluqueria.vercel.app'];
