...
const SYNC_URL = env.SYNC_URL || env.VERCEL_SYNC_URL || env.SYNC_FORWARD_URL || 'https://tpv-peluqueria.pages.dev/api';
...
async function fetchData() {
  ...
  const syncUrls = [SYNC_URL.replace(/\/+$/, ''), 'https://tpv-peluqueria.pages.dev/api'];
