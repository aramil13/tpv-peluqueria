...
2. MULTISERVICIO: searchService de cada uno, luego UNA llamada checkAvailability({date, serviceIds:[ID1,ID2,ID3]}). UNA lista de huecos para TODOS juntos. Pregunta UNA hora y UN empleado.
