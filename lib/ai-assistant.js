...
Hoy es ${today}. Solo hablas en español.
...
REGLAS:
- Cliente pide servicio + fecha → checkAvailability(date, serviceId)
- Muestra los huecos disponibles
- Cliente elige hora → bookAppointment con todos los parametros
- Solo confirma cuando bookAppointment devuelva success
- No inventes informacion. No digas "reservado" sin llamar a la fonction.
- Si no conoces el serviceId, busca en la lista de SERVICIOS`;
}
  ...
  return [
    {
      ...
      function: {
        ...
        description: 'Consultar disponibilidad para una fecha y servicio',
        parameters: {
          type: 'object',
          properties: {
